...
CREATE TABLE attrib_values ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "attrib_id" integer DEFAULT NULL, "attrib_value" varchar(255) DEFAULT NULL, "created_at" datetime DEFAULT NULL, "updated_at" datetime DEFAULT NULL);
...
CREATE TABLE entry_values ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "attrib_id" integer DEFAULT NULL, "attrib_entry_id" integer DEFAULT NULL, "created_at" datetime DEFAULT NULL, "updated_at" datetime DEFAULT NULL);
